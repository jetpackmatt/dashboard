...
export default function InvoicesContent() {
  const { selectedClientId, effectiveIsAdmin, effectiveIsCareUser, clients, hasPermission } = useClient()
    ...
    <PermissionGuard permission="invoices">
      ...
      <div className="flex flex-1 flex-col overflow-x-hidden bg-background rounded-t-xl">
        <div className="@container/main flex flex-col w-full h-[calc(100vh-64px)] px-6 lg:px-8">
          ...
          <div className="sticky top-0 z-20 -mx-6 lg:-mx-8 bg-muted dark:bg-zinc-900 rounded-t-xl font-roboto text-xs">
