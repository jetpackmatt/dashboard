...
export default function CareContent() {
  const { selectedClientId, isAdmin, effectiveIsAdmin, effectiveIsCareUser, effectiveIsCareAdmin, clients, hasPermission } = useClient()
  ...
  return (
    <PermissionGuard permission="care">
        ...
        <div className="sticky top-0 z-20 -mx-4 lg:-mx-6 bg-muted dark:bg-zinc-900 rounded-t-xl font-roboto text-xs">
          ...
          <div className="px-4 lg:px-6 py-[19.5px] flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {hasPermission('care.submit_claims') && (
              ...
              {/* New Ticket Button */}
              {hasPermission('care.edit_tickets') && (
