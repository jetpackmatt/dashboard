 ...
 * Generates draft invoices for all clients for the previous billing week.
 *
  ...
  try {
    ...
    for (const client of clients) {
      ...
      try {
        ...
        if (existingInvoice) {
          console.log(`Invoice already exists for ${client.company_name}, skipping`)
          continue
        }
        ...
        if (lineItems.length === 0) {
          console.log(`No transactions for ${client.company_name}, skipping`)
          continue
        }
