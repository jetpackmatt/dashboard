...
export function getStatusColors(status: string) {
  switch (status) {
    ...
    case "Credit Requested":
      return `bg-orange-100 text-orange-700 border border-orange-200 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800`
    case "Under Review":
...
export function getTicketTypeColors(ticketType: string, issueType?: string) {
  ...
  switch (ticketType) {
    case "Track":
      return `bg-violet-100 text-violet-700 border border-violet-200 dark:bg-violet-900/40 dark:text-violet-300 dark:border-violet-800`
    case "Work Order":
      return `bg-teal-100 text-teal-700 border border-teal-200 dark:bg-teal-900/40 dark:text-teal-300 dark:border-teal-800`
    case "Technical":
      return `bg-slate-100 text-slate-700 border border-slate-200 dark:bg-slate-900/40 dark:text-slate-300 dark:border-slate-800`
    case "Inquiry":
      return `bg-cyan-100 text-cyan-700 border border-cyan-200 dark:bg-cyan-900/40 dark:text-cyan-300 dark:border-cyan-800`
    default:
      return `bg-slate-100 text-slate-700 border border-slate-200 dark:bg-slate-900/40 dark:text-slate-300 dark:border-slate-800`
  }
}
