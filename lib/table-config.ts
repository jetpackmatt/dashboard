...
export const INVOICES_TABLE_CONFIG: TableConfig = {
  columns: [
    ...
    { id: 'catShipping',   header: 'Shipping',       width: 6,  priority: 3 },
    { id: 'catAdditional', header: 'Additional',     width: 6,  priority: 3 },
    { id: 'catReturns',    header: 'Returns',        width: 5,  priority: 3 },
    { id: 'catReceiving',  header: 'Receiving',      width: 5,  priority: 3 },
    { id: 'catStorage',    header: 'Storage',        width: 5,  priority: 3 },
    { id: 'catCredits',    header: 'Credits',        width: 5,  priority: 3 },
